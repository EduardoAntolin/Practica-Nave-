...
float posXTriangulo = 0.0f, posYTriangulo = 0.0f, velocidadTriangulo = 0.8, rotacionTriangulo = 0.2, componenteX = 0.0, componenteY = 0.0;
...
void actualizar() {
	...
	if (estadoDerecha == GLFW_PRESS) {
		rotacionTriangulo -= 0.1;
		if (rotacionTriangulo > 360.0f)
		{
			rotacionTriangulo = 0.0f;
		}
	}
	...
	if (estadoArriba == GLFW_PRESS) {
		componenteX = sinf(2 * 3.1415 * (rotacionTriangulo / 360.0f));
	}
